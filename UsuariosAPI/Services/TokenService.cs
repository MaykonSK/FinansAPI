...
namespace UsuariosAPI.Services
{
    public class TokenService
    {
        ...
        public Token CreateToken(CustomIdentityUser usuario, string role)
        {
            ...
            var token = new JwtSecurityToken(claims: direitosUsuario, signingCredentials: credenciais, expires: DateTime.UtcNow.AddHours(2)); //tempo de expiração do token 1h
